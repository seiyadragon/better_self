...
const Habit = ({name, days, id}: HabitProps) => {
    ...
    return (
        <section className="flex text-white my-4 text-base bg-blue-900 shadow-lg rounded-full border-t-2 border-b-2 border-blue-600">
            <p className="bg-blue-800 w-24 h-36 py-4 px-4 text-center overflow-x-hidden shadow-lg rounded-full border-l-2 border-orange-400">{finalName}</p>
            <p className="bg-blue-800 w-24 h-36 py-4 px-4 ml-4 text-center overflow-x-hidden shadow-lg rounded-full">{days} days</p>
            <section className="ml-4 w-24 h-36 shadow-lg bg-blue-800 py-6 rounded-full border-r-2 border-orange-400">
