...
const LoginManager = () => {
    return (
        <main className="bg-gray-800">
            ...
            <section className="min-h-screen flex flex-col mx-4 md:mx-12 lg:mx-24 gap-12">
                <section className="text-white bg-blue-900 rounded-xl border-b-4 border-blue-700 my-4 text-base py-4 px-4 w-full h-64">
                    {
                        `
                ...
                <section className="text-white bg-blue-900 rounded-xl border-b-4 border-blue-700 my-4 w-full h-64 px-4">
                    <p className="text-base py-4">{"Click the button below to Sign Up for free! Or Log In if you already have an account!"}</p>
